...
#include "AdvancedAimRecoilCharacter.generated.h"
...
UCLASS(config=Game)
class AAdvancedAimRecoilCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AAdvancedAimRecoilProjectile> ProjectileClass;
